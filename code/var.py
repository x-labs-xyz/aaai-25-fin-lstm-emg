"""
This function is the main function of learning Variance feature with FIN
"""
...
# if args.z_score_norm:
#     X_test = preprocessing.scale(X_test)
X_test_VAR = preprocessing.scale(X_test_VAR)
x_te = X_test
y_te = X_test_VAR
...
# if args.z_score_norm:
#     X_train = preprocessing.scale(X_train)
X_train_VAR = preprocessing.scale(X_train_VAR)
x = X_train
y = X_train_VAR
