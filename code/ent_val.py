...
def arg_parser():
    parser = argparse.ArgumentParser(description='ent_args')
...
X_test_RMS = (X_test_RMS-0.3957438647053795)/0.9240087261550427 # z-score norm with mean and sigma same as training set.
x_te = X_test
y_te = X_test_RMS
...
np.savetxt('RMS0_R2'+str(args.prediction)+'.txt', my_array, fmt='%.4f')
...
plt.title("R2 RMS Distribution")
plt.xlabel("Accuracy")
plt.ylabel("Frequency")
plt.savefig("rms0_R2"+str(args.prediction)+".png")